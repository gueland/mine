...
.GUID 4302acec-8c86-4908-9801-6718802af728

.AUTHOR 
    Jake Morrison - TechThoughts - http://techthoughts.info

.COMPANYNAME 
    TechThoughts

.COPYRIGHT 
    Jake Morrison - please credit TechThoughts - http://techthoughts.info if used
...
.RELEASENOTES
    Initial Release - More info on this script and video demo at: http://techthoughts.info/diag-v/
#>

<# 

.DESCRIPTION 
 Diag-V is a collection of various Hyper-V diagnostics. It presents the user a simple choice menu that allows the user to select and execute the desired diagnostic. Each diagnostic is a fully independent function which can be copied and run independent of Diag-V if desired. 
